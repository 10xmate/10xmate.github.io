...
const popupText = segments.includes('bg')
  ? 'Използваме бисквитки, за да анализираме данните от употребата на уебсайта. Можете да продължите да разглеждате, получавайки всички бисквитки, които сайтът използва или да промените своите настройки за бисквитки.'
  : 'We use cookies to analyse the data received for this website use. If you continue without changing your settings, wе’ll assume that you are happy to receive all cookies on this website.'
